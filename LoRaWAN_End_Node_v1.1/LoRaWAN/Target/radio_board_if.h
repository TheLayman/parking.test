...
#define RF_SW_CNTRL_PIN                          GPIO_PIN_12
#define RF_SW_CNTRL_GPIO_PORT                    GPIOB
#define RF_SW_CNTRL_GPIO_CLK_ENABLE()            __HAL_RCC_GPIOB_CLK_ENABLE()
#define RF_SW_CNTRL_GPIO_CLK_DISABLE()           __HAL_RCC_GPIOB_CLK_DISABLE()
...
#define RF_SW_VDD_GPIO_PORT                    GPIOA
#define RF_SW_VDD_GPIO_CLK_ENABLE()            __HAL_RCC_GPIOA_CLK_ENABLE()
#define RF_SW_VDD_GPIO_CLK_DISABLE()           __HAL_RCC_GPIOA_CLK_DISABLE()
