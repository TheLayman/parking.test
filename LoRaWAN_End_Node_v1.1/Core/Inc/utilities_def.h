...
typedef enum
{
  ...
  CFG_SEQ_Task_LoRaReadBMM350Event,
  CFG_SEQ_Task_SendHBEvent,
  CFG_SEQ_Task_BatteryCheckEvent,
  CFG_SEQ_Task_TemperatureCheckEvent,
  CFG_SEQ_Task_RetransmitEvent,
  CFG_SEQ_Task_JoinEvent,
